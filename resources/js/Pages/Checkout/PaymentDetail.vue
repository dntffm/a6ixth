<template>
    <section class="flex flex-col h-screen">
        ...
        <div class="flex flex-col md:flex-grow">
            <div class="w-full md:w-3/4 bg-background">
                <div class="p-5 md:pl-10 md:pr-16 py-10 font-cantarell">
                    ...
                    <div class="flex flex-col gap-2">
                        <div class="group space-x-3">
                            <input v-model="paymentMethod" type="radio" name="" id="method" value="a"
                                class="checked:bg-black focus:bg-black">
                            <span>Pay with Credit Card</span>
                        </div>
                        <div class="group space-x-3">
                            <input v-model="paymentMethod" type="radio" name="" id="method" value="b"
                                class="checked:bg-black focus:bg-black">
                            <span>Pay with Gift Card</span>
                        </div>
                        <div class="group space-x-3 flex flex-row items-center">
                            <input v-model="paymentMethod" type="radio" name="" id="method" value="c"
                                class="checked:bg-black focus:bg-black">
                            <span>
                        ...
                        <div class="group my-4">
                            <input class="w-full lg:w-[80%] bg-background border-black mb-4 text-xl p-4 font-cantarell " type="text"
                                name="" id="" placeholder="Enter Voucher Number" />
                        </div>
                    </div>

                    <AsixthBlackButton @click="submitOrder" class="w-full lg:w-1/3">Submit Order</AsixthBlackButton>
                </div>
            </div>
            <div class="w-full lg:w-1/2 bg-[#F8F3DF] flex justify-center items-center">
...
function submitOrder() {
    router.get(route('checkout.finish'))
}
